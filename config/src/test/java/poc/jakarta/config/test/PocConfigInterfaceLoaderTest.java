...
public class PocConfigInterfaceLoaderTest {
    @Configuration
    public static interface JakartaConfigProperties {
        String property1();
...
//        String property5;
    ...
    public void testDefaultProperties() {
        JakartaConfigProperties properties = Loader.bootstrap().load(JakartaConfigProperties.class);
        ...
        Assertions.assertThrows(ConfigException.class, () -> properties.property2().sub());
    ...
    @Configuration
    public static interface SomeSub {
        String sub1();
        String sub2();
    }
